concommand.Add("smore_safe_flush_lod", function(ply, cmd, args, argStr)
	hook.Add("PreRender", "TTT2SMORE_FlushLODNoCrash", function()
		...
		if re_enable_mcore then RunConsoleCommand("gmod_mcore_test", "0") end
		...
		-- vehicle_flushscript
		-- vox_reload
		if re_enable_mcore then RunConsoleCommand("gmod_mcore_test", "1") end
		hook.Remove("PreRender", "TTT2SMORE_FlushLODNoCrash")
		return true
	end)
end, "Buffers a r_flushlod during a situation where it won't crash your client.")